...
class AssignRoleCards : AppCompatActivity() {
    ...
    companion object
    {
        ...
        const val ROLE_NAME_LECTER = "Dr. Lecter"
        ...
        fun getRoleLocalName(context: Context, role: RoleTypes) : String
        {
            return when (role) {
                ...
                RoleTypes.LECTER -> context.getString(R.string.role_lecter)
            }
        }
        ...
        fun getRoleName(context: Context, roleType: RoleTypes) : String {
            return when(roleType)
            {
                ...
                RoleTypes.LECTER -> ROLE_NAME_LECTER
            }
        }
        ...
        fun getRole(context: Context, roleType: RoleTypes) : Role
        {
            return when(roleType)
            {
                ...
                RoleTypes.LECTER -> Role(ROLE_NAME_LECTER, getRoleLocalName(context, roleType), true, RoleTypes.LECTER)
            }
        }
        ...
        fun getRoleImageCardResource(roleType: RoleTypes) : Int
        {
            return when(roleType)
            {
                ...
                RoleTypes.LECTER -> R.drawable.card_lecter
            }
        }
        ...
        fun getRoleImageThumbnailResource(role: RoleTypes) : Int {
            return when(role)
            {
                ...
                RoleTypes.LECTER -> R.drawable.role_lecter
            }
        }
    }
